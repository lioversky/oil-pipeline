...
public class FieldAddProcessorTest {
  ...
  public void testCopyFieldNotExist() {
    ...
    Map<String, Object> params = ImmutableMap
        .of("params",ImmutableMap.of("sourceField", "copy"), "targetField", "copy1", "subType", "fieldadd_copy");
  ...
  public void testAddCurDateStr() {
    ...
    Map<String, Object> data = Maps.newHashMap(ImmutableMap.of("copy", "copydata"));
    Map<String, Object> params = ImmutableMap
        .of("targetField", targetField, "subType", "fieldadd_datestr", "params",ImmutableMap.of("dateFormat", dateFormat));
    Processor p = ProcessorTypeEnum.getType(test_type)
        .getProcessor(params);
