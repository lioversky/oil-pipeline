 ...
 */
public class ExtendArgsConvertor extends ConvertProcessor {
  ...
  public ExtendArgsConvertor(Map<String, Object> params) {
    super(params);
  ...
  public Object converte(Object object) {
    ...
    Map<String, String> argsMap = StringUtil.extendArgsSplit(urlargs);
